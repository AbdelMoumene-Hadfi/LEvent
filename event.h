...
#define OFF(bit) ((bit)%BITS_PER_LONG)
...
char *keys[KEY_MAX + 1] = {
	...
	[KEY_DEL_LINE] = "Delete line",  [KEY_RFKILL] = "KEY_RFKILL",
};
...
int maxes[EV_MAX + 1] = {
	[0 ... EV_MAX] = 0,
	[EV_SYN] = 0,			[EV_REL] = REL_MAX+1,
	[EV_KEY] = KEY_MAX+1,			[EV_ABS] = ABS_MAX+1,
	[EV_MSC] = MSC_MAX+1,			[EV_LED] = LED_MAX+1,
	[EV_SND] = SND_MAX+1,			[EV_REP] = REP_MAX+1,
};
